    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4 py-8">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Join SPACIFY</h1>
          <p className="text-gray-600">Create your account and start parking hassle-free!</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="bg-gray-50 rounded-lg p-3">
              ...
              <ul className="text-xs text-gray-600 space-y-1">
                ...
                <li className={`flex items-center ${formData.password !== formData.confirmPassword || !formData.confirmPassword ? '' : 'text-green-600'}`}>
                  <div className={`w-2 h-2 rounded-full mr-2 ${formData.password === formData.confirmPassword && formData.confirmPassword ? 'bg-green-500' : 'bg-gray-300'}`}></div>
                  Passwords match
                </li>
              </ul>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/auth/login" className="text-blue-600 hover:text-blue-800 font-semibold underline">
                Sign in here
              </Link>
            </p>
          </div>
